export default function Home() {
  return (
    <div className="flex w-full h-screen bg-white font-sans">
      <main className="flex flex-row w-full max-w-8xl py-32 px-16 h-full">
        <div className="bg-teal-50 flex flex-col w-2/5 h-max border-2 border-teal-800 rounded-xl"> 
        ...
        <div className="w-5/6 flex flex-col border border-gray-100 p-6 rounded-lg h-full">
            <div className="w-full flex flex-row">
                ...
                <button className="flex bg-amber-400 text-black rounded-lg py-1 px-3 h-max hover:cursor-pointer">Apply</button>
