...
export default function DatePicker() {
    ...
    return (
            ...
            <button type="button" onClick={() => setIsOpen(!isOpen)} className="w-full flex items-center justify-between px-4 py-2 text-gray-600 border-2 border-gray-300 rounded-lg hover:border-gray-400 focus:outline-none">
                <span>{selectedDate ? formatDate(selectedDate) : "Select your date of birth"}</span>
